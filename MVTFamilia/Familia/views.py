...
def crear_familiar(request):
    ...
    lucas = Familia(nombre="Lucas",apellido="Gutierez",edad=45,rol="padre",profesion="herrero",fecha_de_nacimiento="1977-08-03")
    miriam = Familia(nombre="Miriam",apellido="Vazquez",edad=47,rol="madre",profesion="docente en un secundario del Estado",fecha_de_nacimiento="1.975-02-17")
    milagros = Familia(nombre="Milagros",apellido="Gutierez",edad=15,rol="hija",profesion="estudiante",fecha_de_nacimiento="2007-11-8")
    dict_de_contexto = {
